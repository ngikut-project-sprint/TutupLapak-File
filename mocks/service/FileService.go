...
func (_m *FileService) GenerateThumbnail(ctx context.Context, file *multipart.FileHeader, fileName string, completion chan model.Completion) {
...
func (_c *FileService_GenerateThumbnail_Call) Run(run func(ctx context.Context, file *multipart.FileHeader, fileName string, completion chan model.Completion)) *FileService_GenerateThumbnail_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*multipart.FileHeader), args[2].(string), args[3].(chan model.Completion))
	})
	return _c
}
...
func (_c *FileService_GenerateThumbnail_Call) RunAndReturn(run func(context.Context, *multipart.FileHeader, string, chan model.Completion)) *FileService_GenerateThumbnail_Call {
	_c.Run(run)
	return _c
}

// UploadFile provides a mock function with given fields: ctx, file, fileName, completion
func (_m *FileService) UploadFile(ctx context.Context, file *multipart.FileHeader, fileName string, completion chan model.Completion) {
	_m.Called(ctx, file, fileName, completion)
}
...
func (_c *FileService_UploadFile_Call) Run(run func(ctx context.Context, file *multipart.FileHeader, fileName string, completion chan model.Completion)) *FileService_UploadFile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*multipart.FileHeader), args[2].(string), args[3].(chan model.Completion))
	})
	return _c
...
func (_c *FileService_UploadFile_Call) RunAndReturn(run func(context.Context, *multipart.FileHeader, string, chan model.Completion)) *FileService_UploadFile_Call {
	_c.Run(run)
	return _c
}
